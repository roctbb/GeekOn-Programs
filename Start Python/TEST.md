## Итоговый зачет по прикладному программированию на Python
...
1. Напишите веб-сервис, на котором можно загрузить картинку и получить ее двуцветную (например, чернобелую) версию.

2. Напишите телеграм бота для игры в "Угадай число".
